...
.PHONY: help init infra dev backend frontend frontend-i18n-check frontend-local-backend-demo-check frontend-production-smoke-check customer-demo-ui-smoke-check interactive-demo-conversion-check guided-learning-flow-check local-backend-demo-browser-drill paper-approval-ui-flow-smoke-check website website-build website-preview website-check website-content-check website-deploy roadmap-status release-readiness-check customer-evaluation-check customer-demo-env-check self-service-paper-demo-check self-service-paper-demo-launcher-check hosted-backend-readiness-check hosted-web-command-center-check hosted-paper-api-readiness-check hosted-paper-sandbox-onboarding-check hosted-paper-security-operations-check hosted-paper-datastore-migration-plan hosted-paper-production-datastore-readiness-check hosted-paper-production-datastore-migration-plan-v2 hosted-paper-auth-boundary-check hosted-paper-auth-provider-selection-check hosted-paper-identity-readiness-check hosted-paper-identity-access-check hosted-paper-mock-session-check hosted-paper-tenant-boundary-evidence-export start-customer-demo launch-self-service-paper-demo social-content-check social-daily-pack social-4-post-pack social-open social-growth-status facebook-launch-check seed-paper-execution-demo paper-demo-evidence-export paper-broker-simulation-evidence-export browser-only-mock-demo-check mock-backend-demo-check paper-risk-evidence-export paper-audit-integrity-check paper-audit-worm-readiness-check paper-audit-compliance-trail-readiness-check paper-simulation-submit-check paper-approval-workflow-check paper-compliance-approval-readiness-check paper-execution-workflow-check paper-execution-persistence-check paper-risk-guardrails-check paper-risk-cross-account-readiness-check paper-broker-simulation-model-check paper-broker-simulation-ui-check paper-broker-simulation-readiness-check paper-oms-reliability-check paper-oms-timeout-check paper-oms-production-readiness-check paper-oms-productionization-blueprint-check data-fixtures-check rollover-fixtures-check continuous-futures-preview feature-manifest-preview strategy-research-preview backtest-preview backtest-result-preview toy-backtest backtest-artifact-preview backtest-artifact-index-preview backtest-artifact-comparison-preview backtest-research-bundle-preview backtest-research-bundle-index-preview research-review-queue-preview research-review-decision-preview research-review-decision-index-preview research-review-packet-preview sample-research-review-packet research-review-packet-fixtures-check data-quality-reports-dry-run data-version-register-dry-run data-migrations-dry-run data-platform-verify architecture-status architecture-docs-check architecture-safety-check business-docs-check business-compliance-check business-status check test codex-prompt clean
...
help:
	...
	@printf '  make frontend-local-backend-demo-check Validate local backend demo boundary docs/UI\n'
	...
	@printf '  make interactive-demo-conversion-check Validate deployed interactive demo conversion UX copy\n'
	@printf '  make guided-learning-flow-check Validate deployed guided learning workflow copy\n'
	@printf '  make local-backend-demo-browser-drill Verify local backend + SQLite records in browser\n'
	...
	@printf '  make hosted-backend-readiness-check Validate hosted backend/API deployment foundation\n'
	@printf '  make hosted-web-command-center-check Validate hosted Web Command Center API base URL boundary\n'
	@printf '  make hosted-paper-api-readiness-check Validate hosted paper backend/API readiness boundary\n'
	@printf '  make hosted-paper-sandbox-onboarding-check Validate hosted paper sandbox tenant onboarding boundary\n'
	@printf '  make hosted-paper-security-operations-check Validate hosted paper security/operations readiness boundary\n'
	@printf '  make hosted-paper-datastore-migration-plan Generate hosted paper datastore migration plan dry-run\n'
	@printf '  make hosted-paper-production-datastore-readiness-check Validate hosted paper production datastore boundary\n'
	@printf '  make hosted-paper-production-datastore-migration-plan-v2 Generate production datastore migration blueprint v2 dry-run\n'
	@printf '  make hosted-paper-auth-boundary-check Validate hosted paper auth/session/RBAC boundary\n'
	@printf '  make hosted-paper-auth-provider-selection-check Validate hosted paper auth provider selection matrix\n'
	@printf '  make hosted-paper-identity-readiness-check Validate hosted paper identity/RBAC/tenant readiness boundary\n'
	@printf '  make hosted-paper-identity-access-check Validate hosted paper identity access contract\n'
	...
	@printf '  make social-content-check Validate Facebook growth operations safety copy\n'
	@printf '  make social-daily-pack Generate today'\''s Facebook copy-paste pack\n'
	@printf '  make social-4-post-pack Generate 2 Page + 2 Group manual Facebook post pack\n'
	@printf '  make social-open Open manual Facebook workspace tabs\n'
	@printf '  make social-growth-status Print Facebook growth operations status\n'
	...
	@printf '  make browser-only-mock-demo-check Validate browser-only interactive mock demo runtime\n'
	@printf '  make mock-backend-demo-check Validate deterministic Mock Backend Demo MVP\n'
	...
	@printf '  make paper-audit-compliance-trail-readiness-check Verify formal audit/compliance trail readiness boundary\n'
	...
	@printf '  make paper-risk-guardrails-check Validate expanded Paper Only risk guardrails\n'
	@printf '  make paper-risk-cross-account-readiness-check Validate Paper Risk cross-account readiness boundary\n'
	@printf '  make paper-broker-simulation-model-check Validate local quote-based paper broker simulation model\n'
	@printf '  make paper-broker-simulation-ui-check Validate paper broker simulation UI controls\n'
	@printf '  make paper-broker-simulation-readiness-check Validate paper broker simulation readiness boundary\n'
	...
	@printf '  make paper-oms-production-readiness-check Validate Paper OMS non-production readiness boundary\n'
	@printf '  make paper-oms-productionization-blueprint-check Validate Paper OMS productionization blueprint boundary\n'
...
hosted-backend-readiness-check:
	...
	cd backend && . .venv/bin/activate && pytest tests/test_hosted_backend_environment_routes.py

hosted-web-command-center-check:
	bash scripts/hosted-web-command-center-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_hosted_web_command_center_routes.py

hosted-paper-api-readiness-check:
	bash scripts/hosted-paper-api-readiness-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_hosted_paper_environment_routes.py tests/test_hosted_paper_readiness_routes.py tests/test_hosted_paper_datastore_readiness_routes.py tests/test_hosted_paper_datastore_migration_plan_script.py

hosted-paper-sandbox-onboarding-check:
	bash scripts/hosted-paper-sandbox-onboarding-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_hosted_paper_sandbox_onboarding_routes.py

hosted-paper-security-operations-check:
	bash scripts/hosted-paper-security-operations-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_hosted_paper_security_operations_routes.py

hosted-paper-datastore-migration-plan:
	backend/.venv/bin/python scripts/hosted-paper-datastore-migration-plan.py

hosted-paper-production-datastore-readiness-check:
	bash scripts/hosted-paper-production-datastore-readiness-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_hosted_paper_production_datastore_readiness_routes.py
...
hosted-paper-auth-provider-selection-check:
	bash scripts/hosted-paper-auth-provider-selection-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_hosted_paper_auth_provider_selection_routes.py

hosted-paper-identity-readiness-check:
	bash scripts/hosted-paper-identity-readiness-check.sh

hosted-paper-identity-access-check:
	bash scripts/hosted-paper-identity-access-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_hosted_paper_identity_access_contract_routes.py

hosted-paper-mock-session-check:
...
social-daily-pack:
	python3 scripts/social/generate_daily_facebook_pack.py

social-4-post-pack:
	python3 scripts/social/generate_4_post_facebook_pack.py

social-open:
	bash scripts/social/open_facebook_workspace.sh

social-growth-status:
	bash scripts/social-growth-status.sh

facebook-launch-check:
	bash scripts/social-content-check.sh
	test -f docs/facebook-human-launch-runbook.md
	@echo "Facebook launch runbook OK"
...
paper-audit-integrity-check:
	tmp_dir="$$(mktemp -d)"; \
	PAPER_EXECUTION_AUDIT_DB_PATH="$$tmp_dir/paper_audit_integrity.sqlite" \
		backend/.venv/bin/python scripts/seed-paper-execution-demo.py >/dev/null; \
	PAPER_EXECUTION_AUDIT_DB_PATH="$$tmp_dir/paper_audit_integrity.sqlite" \
...
paper-audit-compliance-trail-readiness-check:
	bash scripts/paper-audit-compliance-trail-readiness-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_paper_audit_compliance_trail_routes.py
...
paper-compliance-approval-readiness-check:
...
paper-risk-guardrails-check:
	cd backend && . .venv/bin/activate && pytest tests/test_paper_risk_guardrails.py

paper-risk-cross-account-readiness-check:
	bash scripts/paper-risk-cross-account-readiness-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_paper_risk_cross_account_readiness_routes.py

paper-broker-simulation-model-check:
	cd backend && . .venv/bin/activate && pytest tests/test_paper_broker_simulation.py tests/test_paper_broker_gateway.py tests/test_paper_execution_workflow.py tests/test_paper_execution_routes.py tests/test_paper_broker_simulation_evidence_export_script.py

paper-broker-simulation-ui-check:
	node frontend/scripts/check-command-center-i18n.mjs
	cd frontend && npm run typecheck

paper-broker-simulation-readiness-check:
	bash scripts/paper-broker-simulation-readiness-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_paper_broker_simulation_readiness_routes.py

browser-only-mock-demo-check:
	bash scripts/browser-only-mock-demo-check.sh

mock-backend-demo-check:
	bash scripts/mock-backend-demo-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_mock_backend_routes.py
...
paper-oms-production-readiness-check:
	bash scripts/paper-oms-production-readiness-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_paper_oms_production_readiness_routes.py

paper-oms-productionization-blueprint-check:
	bash scripts/paper-oms-productionization-blueprint-check.sh
	cd backend && . .venv/bin/activate && pytest tests/test_paper_oms_productionization_blueprint_routes.py
