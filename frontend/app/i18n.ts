  ...
  en: {
    ...
    browserOnlyMockDemo: {
      ...
      marketRealismVisualization: {
        eyebrow: "Market Realism Visualization",
        title: "Regime, spread, liquidity, slippage, and fill reason",
        description:
        ...
        regimeKicker: "Regime Timeline",
        regimeTitle: "Deterministic market state sequence",
        regimeTimelineLabel: "Market regime timeline by tick",
        microstructureKicker: "Quote Quality",
        microstructureTitle: "Spread, liquidity, quote age, and slippage meters",
        fillKicker: "Fill Explanation",
        fillTitle: "Why the simulated paper order filled, partially filled, or rejected",
        pnlKicker: "Paper PnL Context",
        pnlTitle: "Position and mark-to-market context",
        noOrderYet:
        ...
        regimes: {
          normal: {
            label: "Normal",
            description: "Narrower spread, healthier quote size, and lower quote age.",
          },
          trending: {
            label: "Trending",
            description: "Directional deterministic price movement with moderate liquidity.",
          },
          volatile: {
            label: "Volatile",
            description: "Wider spread, larger price movement, and lower liquidity score.",
          },
          illiquid: {
            label: "Illiquid",
            description: "Limited bid / ask size can cause partial fill or reject outcomes.",
          },
          stale_quote: {
            label: "Stale quote",
            description: "Older quote snapshots are rejected by paper risk guardrails.",
          },
        },
        safety: [
          "Browser-only",
  ...
  zh: {
    ...
    browserOnlyMockDemo: {
      ...
      marketRealismVisualization: {
        ...
        regimeKicker: "市場狀態時間線",
        regimeTitle: "Deterministic market state sequence",
        regimeTimelineLabel: "Market regime timeline by tick",
        microstructureKicker: "Quote Quality",
        microstructureTitle: "價差、流動性、quote age 與滑價量表",
        fillKicker: "成交說明",
        fillTitle: "為何模擬紙上訂單成交、部分成交或被拒絕",
        pnlKicker: "Paper PnL Context",
        pnlTitle: "持倉與 mark-to-market context",
        noOrderYet:
        ...
        regimes: {
          normal: {
            label: "Normal",
            description: "價差較窄、quote size 較健康、quote age 較低。",
          },
          trending: {
            label: "Trending",
            description: "Deterministic 價格方向較明確，流動性中等。",
          },
          volatile: {
            label: "Volatile",
            description: "價差較寬、價格變動較大、流動性分數較低。",
          },
          illiquid: {
            label: "Illiquid",
            description: "Bid / ask size 有限，可能造成部分成交或拒單。",
          },
          stale_quote: {
            label: "Stale quote",
            description: "Quote snapshot 較舊，會被 paper risk guardrails 拒絕。",
          },
        },
        safety: [
          "Browser-only",
