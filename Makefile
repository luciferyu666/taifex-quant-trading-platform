...
paper-execution-workflow-check:
	cd backend && . .venv/bin/activate && pytest tests/test_paper_execution_workflow.py tests/test_paper_execution_routes.py tests/test_paper_execution_store.py tests/test_seed_paper_execution_demo_script.py

paper-execution-persistence-check:
	cd backend && . .venv/bin/activate && pytest tests/test_paper_execution_store.py tests/test_paper_execution_routes.py tests/test_seed_paper_execution_demo_script.py
